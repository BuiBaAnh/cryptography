...
def create16Key56(key):
    table = [1,1,2,2,2,2,2,2,1,2,2,2,2,2,2,1]
    newkey = readKey64(key)
    L = newkey[:28]
    R = newkey[28:]
    lst = []
    for i in range(16):
...
def create16Key48(text):
    lst = create16Key56(text)
    table = [14, 17, 11, 24, 1, 5,
            3, 28, 15, 6, 21, 10,
            23, 19, 12, 4, 26, 8,
            16, 7, 27, 20, 13, 2,
...
[2,1,14,7,4,10,8,13,15,12,9,0,3,5,6,11]]
    ...
    while(i < 48):
        newtext = text[i:i+6]
        teta = newtext[0] + newtext[5] 
        row = int(teta,2)
        gama = newtext[1:5]
        col = int(gama,2)
        newvalue = table[j][row][col]
        final = bin(newvalue)
        _final = final[2:]
        _Box += parseTo4(_final)
        j = j + 1
        i = i + 6
    return _Box
